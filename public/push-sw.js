...
// Cho phép trang chủ động ra lệnh "áp dụng bản mới ngay" (thay vì tự động kích hoạt
// ngay khi cài xong — workbox.skipWaiting đã tắt trong vite.config.ts để chờ lệnh này).
