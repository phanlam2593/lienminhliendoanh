...
const DICT: Record<Lang, Record<string, string>> = {
  vi: {
    ...
    "bizForm.adminNoteHint": "Chỉnh sửa nội dung bên dưới rồi bấm \"Lưu doanh nghiệp\" — hồ sơ sẽ tự động gửi lại để duyệt.",
    ...
    "bizForm.pinHint": "Giống kiểu đặt mật khẩu WiFi của quán. Đọc cho khách khi họ tới để họ nhập, xác nhận nhận ưu đãi. Có thể đổi bất cứ lúc nào.",
    ...
    "offerRow.broadcastDesc": "Thông báo về \"{title}\" sẽ được gửi đến tất cả thành viên đang theo dõi doanh nghiệp của bạn.",
    ...
    "register.bizSaveFailed": "Tài khoản đã tạo thành công, nhưng lưu thông tin doanh nghiệp bị lỗi. Vào Hồ sơ để thêm lại doanh nghiệp của bạn.",
  ...
  en: {
    ...
    "bizForm.adminNoteHint": "Edit the details below then press \"Save business\" — your profile is resubmitted for review automatically.",
    ...
    "bizForm.pinHint": "Like setting your shop's WiFi password. Read it to customers when they arrive so they can enter it to claim an offer. You can change it anytime.",
    ...
    "register.bizSaveFailed": "Your account was created, but saving your business info failed. Go to Profile to add your business again.",
