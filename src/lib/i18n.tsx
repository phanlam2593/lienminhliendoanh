...
const DICT: Record<Lang, Record<string, string>> = {
  vi: {
    ...
    "quet.contactHidden": "Thông tin liên hệ sẽ hiện sau khi match",
    "quet.like": "Thích",
    "quet.pass": "Bỏ qua",
    "quet.matchToast": "🎉 Match rồi! Nhắn tin ngay nhé.",
    "quet.createNeed": "Tạo nhu cầu",
    "quet.emptyMyNeeds": "Bạn chưa có nhu cầu nào",
    "quet.emptyMatches": "Chưa có match nào",
  ...
  en: {
    ...
    "quet.contactHidden": "Contact info shown after matching",
    "quet.like": "Like",
    "quet.pass": "Pass",
    "quet.matchToast": "🎉 It's a match! Start chatting.",
    "quet.createNeed": "Create a need",
    "quet.emptyMyNeeds": "You have no needs yet",
    "quet.emptyMatches": "No matches yet",
