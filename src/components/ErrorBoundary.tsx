    ...
    const text =
      lang === "en"
        ? {
            ...
            desc: "The app ran into an unexpected issue. You can retry or go back home — your data is safe.",
            retry: "Retry",
            home: "Go home",
          }
        : {
            title: "Đã có lỗi xảy ra",
            desc: "Ứng dụng gặp sự cố ngoài mong đợi. Bạn có thể thử lại hoặc quay về trang chủ — dữ liệu của bạn vẫn an toàn.",
            retry: "Thử lại",
            home: "Về trang chủ",
          };
