    ...
    <>
      <div className="flex gap-2 overflow-x-auto pb-1 -mx-1 px-1 snap-x">
        {thumbs.map((p, i) => (
          <button
            ...
            aria-label={t("gallery.photoAlt", { n: i + 1 })}
          >
      ...
      {idx !== null && (
        <div className="fixed inset-0 z-[60] bg-black/95 flex items-center justify-center" onClick={close}>
          ...
          <div
            className="max-w-full max-h-full p-6 flex flex-col items-center gap-3"
          ...
          >
            ...
            />
            {all[idx].caption && <div className="text-white/90 text-sm text-center max-w-lg">{all[idx].caption}</div>}
