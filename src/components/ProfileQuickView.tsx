              ...
              <div>
                ...
                {false && (p.status_message && (
                  <div className="inline-block max-w-full px-3 py-1.5 rounded-2xl bg-card border border-border shadow-sm mt-1">
                    <span className="text-sm text-primary italic font-medium line-clamp-2">"{p.status_message.length > 60 ? p.status_message.slice(0, 60) + "…" : p.status_message}"</span>
                  </div>
                ))}
